...
type AppRole = 'admin' | 'employee' | 'site_admin_officer' | 'encoder' | 'worker';
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ user, session, role, employeeId, organizationId, isSuperAdmin, loading, signIn, signUp, signOut }}>
      {children}
