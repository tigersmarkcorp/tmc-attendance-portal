          ...
          <Tabs defaultValue="personal" className="w-full">
            ...
            <TabsContent value="work" className="mt-4 space-y-0">
              ...
              <div className="pt-3 mt-3 border-t border-border/40">
                ...
                <InfoRow label="SSS Number" value={info.sss_number} />
                <InfoRow label="TIN ID" value={info.tin_id} />
                <InfoRow label="Pag-IBIG ID" value={info.pagibig_id} />
                <InfoRow label="PhilHealth ID" value={info.philhealth_id} />
                <InfoRow label="NBI Clearance ID" value={info.nbi_id} />
              </div>
              <div className="pt-3 mt-3 border-t border-border/40">
                <p className="text-[9px] text-muted-foreground font-bold uppercase tracking-[0.15em] mb-2 flex items-center gap-1.5">
