...
export function EmployeeDetailSheet({
  ...
  const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const filePath = `${employee.id}/profile.${fileExt}`;
            ...
            <div className="flex items-start gap-4">
              <div className="relative group">
                <Avatar className="w-20 h-20 border-4 border-background shadow-xl">
                  <AvatarImage src={formData.photo_url || employee.photo_url || ''} />
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => setFormData({ ...formData, tin_id: e.target.value })}
                          className="mt-1"
                        />
                      ) : (
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => setFormData({ ...formData, pagibig_id: e.target.value })}
                          className="mt-1"
                        />
                      ) : (
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => setFormData({ ...formData, philhealth_id: e.target.value })}
                          className="mt-1"
                        />
                      ) : (
                    ...
                    <div className="col-span-2">
                      ...
                      {isEditing ? (
                        <Input
                          value={formData.nbi_id || ''}
                          onChange={(e) => setFormData({ ...formData, nbi_id: e.target.value })}
                          className="mt-1"
                        />
                      ) : (
