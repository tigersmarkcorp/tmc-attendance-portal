      ...
      <Tabs defaultValue="personal" className="w-full">
        ...
        <TabsContent value="personal" className="space-y-4 mt-4">
          ...
          <div className="pt-2 border-t">
            <p className="text-xs font-semibold text-muted-foreground mb-3 uppercase tracking-wider">Government IDs</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>SSS Number</Label>
                <Input value={formData.sssNumber} onChange={(e) => handleChange('sssNumber', e.target.value)} placeholder="00-0000000-0" />
              </div>
              <div className="space-y-2">
                <Label>TIN ID</Label>
                <Input value={formData.tinId} onChange={(e) => handleChange('tinId', e.target.value)} placeholder="000-000-000-000" />
              </div>
              <div className="space-y-2">
                <Label>Pag-IBIG ID</Label>
                <Input value={formData.pagibigId} onChange={(e) => handleChange('pagibigId', e.target.value)} placeholder="0000-0000-0000" />
              </div>
              <div className="space-y-2">
                <Label>PhilHealth ID</Label>
                <Input value={formData.philhealthId} onChange={(e) => handleChange('philhealthId', e.target.value)} placeholder="00-000000000-0" />
              </div>
              <div className="space-y-2 sm:col-span-2">
                <Label>NBI Clearance ID</Label>
                <Input value={formData.nbiId} onChange={(e) => handleChange('nbiId', e.target.value)} />
              </div>
            </div>
          </div>
        </TabsContent>
