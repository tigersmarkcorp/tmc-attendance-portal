...
import { AssignLocationDialog } from '@/components/admin/AssignLocationDialog';
      ...
      <div className="space-y-6">
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50 hover:bg-muted/50">
                      ...
                      <TableHead className="font-semibold">Assigned Location</TableHead>
                    ...
                    {filteredSAOs.map((sao) => {
                      ...
                      return (
                        <TableRow key={sao.id} className="group hover:bg-violet-500/5 transition-colors">
                          ...
                          <TableCell>
                            {getLocationName(sao.assigned_location_id) ? (
                          ...
                          <TableCell>
                            <span className="text-sm font-medium">₱{sao.hourly_rate.toFixed(2)}/hr</span>
                          </TableCell>
                          <TableCell>
        ...
        {saoToAssignLocation && (
          <AssignLocationDialog
            ...
            entityType="employee"
            currentLocationId={saoToAssignLocation.assigned_location_id || null}
