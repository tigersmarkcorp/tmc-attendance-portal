...
export default function LeaveRequests() {
  ...
  const fetchRequests = async () => {
    let query = supabase
      ...
      .select(`
        *,
        employee:employees!leave_requests_employee_id_fkey(first_name, last_name, employee_id, email, department)
      `)
          ...
          {selectedRequest && (
            <div className="space-y-4">
              <div className="p-4 bg-muted rounded-lg space-y-2">
                ...
                <p>
                  <span className="font-medium">Employee #:</span>{' '}
                  {selectedRequest.employee?.employee_id}
                </p>
                <p>
                ...
                {selectedRequest.undertime_hours && (
                  <p>
                    <span className="font-medium">Undertime Hours:</span>{' '}
                    {selectedRequest.undertime_hours}
                  </p>
                )}
