...
export default function PayrollReports() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'payroll_reports' }, () => {
        fetchReports();
      })
      .on('postgres_changes', { event: '*', schema: 'public', table: 'payroll_report_items' }, () => {
        if (selectedReport) {
          viewReportDetails(selectedReport);
        }
      })
      .subscribe();
