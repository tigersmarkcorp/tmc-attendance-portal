...
export default function EncoderLogin() {
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f3ff' }}>
        <div style={{ textAlign: 'center' }}>
          <Loader2 className="w-8 h-8 animate-spin" style={{ color: '#8b5cf6', margin: '0 auto 12px' }} />
          <p style={{ fontSize: 12, color: '#6d28d9', letterSpacing: '0.15em', textTransform: 'uppercase', fontFamily: 'sans-serif' }}>Loading authentication...</p>
        </div>
      </div>
    );
  }
  ...
  const slides = [
    { icon: <Keyboard     className="w-4 h-4" style={{ color: '#fff' }} />, bg: 'rgba(139,92,246,0.75)',  border: 'rgba(139,92,246,0.90)', title: 'Data Entry',        desc: 'Fast and accurate worker record encoding' },
    { icon: <FilePlus     className="w-4 h-4" style={{ color: '#fff' }} />, bg: 'rgba(124,58,237,0.75)',  border: 'rgba(124,58,237,0.90)', title: 'Record Creation',   desc: 'Create new employee & worker profiles' },
    { icon: <FileText     className="w-4 h-4" style={{ color: '#fff' }} />, bg: 'rgba(167,139,250,0.75)', border: 'rgba(167,139,250,0.90)', title: 'Document Encoding', desc: 'Upload and tag employment documents' },
    { icon: <Database     className="w-4 h-4" style={{ color: '#fff' }} />, bg: 'rgba(139,92,246,0.65)',  border: 'rgba(139,92,246,0.80)', title: 'Data Validation',   desc: 'Ensure accuracy with built-in QA tools' },
    { icon: <Search       className="w-4 h-4" style={{ color: '#fff' }} />, bg: 'rgba(124,58,237,0.75)',  border: 'rgba(124,58,237,0.90)', title: 'Record Lookup',    desc: 'Search and retrieve employee data fast' },
    { icon: <ClipboardList className="w-4 h-4" style={{ color: '#fff' }} />, bg: 'rgba(167,139,250,0.75)', border: 'rgba(167,139,250,0.90)', title: 'Batch Processing', desc: 'Handle bulk record imports efficiently' },
  ];

  const tickers = [
    { label: 'Worker Record Encoding',    color: '#8b5cf6' },
    { label: 'Employee Data Entry',       color: '#7c3aed' },
    { label: 'Document Management',       color: '#a78bfa' },
    { label: 'Batch Import Tools',        color: '#c4b5fd' },
    { label: 'Data Validation',           color: '#8b5cf6' },
    { label: 'Quality Assurance',         color: '#7c3aed' },
    { label: 'Record Lookup & Search',    color: '#a78bfa' },
    { label: 'Audit Trail Logging',       color: '#c4b5fd' },
  ];
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sl-bg::after {
          ...
          background: linear-gradient(
            ...
            rgba(245,243,255,0.97) 50%,
            rgba(237,233,254,0.97) 100%
          );
        }
        ...
        .sl-orb-2 {
          ...
          background: radial-gradient(circle at center, rgba(167,139,250,0.18), transparent 68%);
        ...
        .sl-brand-icon {
          ...
          background: rgba(139,92,246,0.60); border: 1px solid rgba(139,92,246,0.80);
          display: flex; align-items: center; justify-content: center;
          box-shadow: 0 0 18px rgba(139,92,246,0.25);
        }
        .sl-brand-name { font-family: 'Syne', sans-serif; font-size: 17px; font-weight: 700; color: #111111; }
        .sl-brand-sub  { font-size: 9px; font-weight: 700; letter-spacing: 0.13em; text-transform: uppercase; color: #8b5cf6; margin-top: 2px; }
        ...
        .sl-carousel::before { left: 0;  background: linear-gradient(to right, rgba(250,248,255,0.95), transparent); }
        .sl-carousel::after  { right: 0; background: linear-gradient(to left,  rgba(250,248,255,0.95), transparent); }

        .sl-slide {
          flex-shrink: 0; width: 192px;
          padding: 15px; border-radius: 13px;
          background: rgba(255,255,255,0.90); border: 1px solid rgba(139,92,246,0.55);
          display: flex; flex-direction: column; gap: 9px;
          box-shadow: 0 2px 12px rgba(139,92,246,0.12);
          transition: border-color 0.2s, background 0.2s, box-shadow 0.2s;
        }
        .sl-slide:hover { border-color: rgba(139,92,246,0.80); background: rgba(255,255,255,0.98); box-shadow: 0 4px 20px rgba(139,92,246,0.22); }
        ...
        .sl-ticker {
          ...
          border-top: 1px solid rgba(139,92,246,0.55); border-bottom: 1px solid rgba(139,92,246,0.55);
          position: relative;
        }
        .sl-ticker::before, .sl-ticker::after {
          content: ''; position: absolute; top: 0; bottom: 0; width: 36px; z-index: 2; pointer-events: none;
        }
        .sl-ticker::before { left: 0;  background: linear-gradient(to right, rgba(250,248,255,0.95), transparent); }
        .sl-ticker::after  { right: 0; background: linear-gradient(to left,  rgba(250,248,255,0.95), transparent); }
        .sl-ticker-track {
          display: flex;
        ...
        .sl-note-title { font-size: 12px; font-weight: 700; color: #7c3aed; margin-bottom: 3px; }
        ...
        .sl-input-wrap svg {
          ...
          width: 14px; height: 14px; color: rgba(139,92,246,0.55); pointer-events: none;
        }
        .sl-input {
          width: 100%; height: 46px; padding: 0 14px 0 38px;
          background: rgba(255,255,255,0.90); border: 1px solid rgba(139,92,246,0.35);
        ...
        .sl-input:focus {
          background: #fff; border-color: rgba(139,92,246,0.60);
        ...
        .sl-btn:hover { transform: translateY(-1px) translateZ(0); box-shadow: 0 10px 34px rgba(139,92,246,0.48); }
        ...
        .sl-divider::before {
          ...
          height: 1px; background: rgba(139,92,246,0.20);
        }
        .sl-divider span {
        ...
        .sl-note-box {
          ...
          background: rgba(255,255,255,0.80); border: 1px solid rgba(139,92,246,0.25);
        ...
        .sl-back:hover { color: #7c3aed; background: rgba(139,92,246,0.14); border-color: rgba(139,92,246,0.45); }
          ...
          <div>
            ...
            <div className="sl-stats">
              <div className="sl-stat">
                <div className="sl-stat-num" style={{ color: '#8b5cf6' }}>Fast</div>
                <div className="sl-stat-label">Data Entry</div>
              </div>
              <div className="sl-stat">
                <div className="sl-stat-num" style={{ color: '#a78bfa' }}>QA</div>
                <div className="sl-stat-label">Validated</div>
              </div>
              <div className="sl-stat">
                <div className="sl-stat-num" style={{ color: '#7c3aed' }}>L1</div>
            ...
            <div className="sl-note">
              <Keyboard className="w-4 h-4" style={{ color: '#8b5cf6', flexShrink: 0, marginTop: 1 }} />
              <div>
        ...
        <div className="sl-right">
          ...
          <div className="sl-form-header">
            <div className="sl-icon-wrap">
              <Keyboard className="w-7 h-7" style={{ color: '#8b5cf6' }} />
            </div>
