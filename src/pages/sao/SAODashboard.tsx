...
import { Loader2, CalendarDays, Clock, DollarSign, TrendingUp, ArrowRight, ShieldCheck, MapPin } from 'lucide-react';
...
export default function SAODashboard() {
  ...
  const [stats, setStats] = useState<SAOStats>({
    hoursThisWeek: 0,
    hoursThisMonth: 0,
    earningsThisMonth: 0,
    leaveBalance: 20,
  ...
  if (loading) {
    return (
      <DashboardLayout title="SAO Dashboard" portalType="sao">
        ...
        <Card className="border-warning">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              Your Site Administration Officer profile is not set up yet. Please contact your administrator to complete your account setup.
            </p>
          </CardContent>
        </Card>
      </DashboardLayout>
    ...
    <DashboardLayout title="SAO Dashboard" portalType="sao">
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm font-medium text-violet-600 dark:text-violet-400">Site Administration Officer</span>
            </div>
            <h2 className="text-2xl font-bold">Welcome back, {employeeName || 'Officer'}!</h2>
            <p className="text-muted-foreground">
              {format(new Date(), 'EEEE, MMMM d, yyyy')}
            </p>
          </div>
          <Button asChild className="bg-gradient-to-r from-violet-500 to-indigo-500 hover:from-violet-600 hover:to-indigo-600">
            <Link to="/sao/leave">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="hover:shadow-md transition-shadow border-violet-500/20">
        ...
        <Card className="border-violet-500/20">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" asChild className="border-violet-500/30 hover:bg-violet-500/10">
                <Link to="/sao/leave">
                  View All
