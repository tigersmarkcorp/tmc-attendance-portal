...
import { SAOWorkLocationMap } from '@/components/sao/SAOWorkLocationMap';
...
export default function SAODashboard() {
  ...
  useEffect(() => {
    const fetchSAOData = async () => {
      ...
      // Build PHT date boundaries for time_entries queries
  ...
  return (
    <DashboardLayout title="SAO Dashboard" portalType="sao">
      <div className="space-y-6">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-xs font-bold text-primary uppercase tracking-widest">Site Administration Officer</span>
              </div>
              <h2 className="text-2xl font-bold tracking-tight">Welcome back, {employeeName || 'Officer'}!</h2>
        ...
        {/* Profile Card */}
        <ProfileCard employeeId={employeeId} role="sao" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 space-y-4">
            ...
            <PersonalInfoTabs entityType="sao" />
          </div>
        ...
        {/* Assigned Work Locations Map */}
        <SAOWorkLocationMap employeeId={employeeId} />
