...
export default function EmployeeLogin() {
  ...
  if (authLoading) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #1a0a00, #2d1200, #1a0a00)' }}>
        <div style={{ textAlign: 'center' }}>
          <Loader2 className="w-8 h-8 animate-spin" style={{ color: '#fb923c', margin: '0 auto 12px' }} />
          <p style={{ fontSize: 12, color: 'rgba(251,146,60,0.6)', letterSpacing: '0.15em', textTransform: 'uppercase' }}>Loading authentication...</p>
        </div>
      </div>
    );
  }
  ...
  const slides = [
    { icon: <Clock className="w-4 h-4" style={{ color: '#fb923c' }} />,     bg: 'rgba(249,115,22,0.18)',  border: 'rgba(249,115,22,0.32)',  title: 'Clock In / Out',    desc: 'Selfie-verified time tracking for secure attendance' },
    { icon: <FileText className="w-4 h-4" style={{ color: '#fdba74' }} />,   bg: 'rgba(251,146,60,0.15)',  border: 'rgba(251,146,60,0.28)',  title: 'View Timesheets',   desc: 'Work hours, overtime and earnings history' },
    { icon: <Calendar className="w-4 h-4" style={{ color: '#fed7aa' }} />,   bg: 'rgba(253,186,116,0.15)', border: 'rgba(253,186,116,0.28)', title: 'Leave Requests',    desc: 'Submit and track leave applications easily' },
    { icon: <Wallet className="w-4 h-4" style={{ color: '#fb923c' }} />,     bg: 'rgba(249,115,22,0.18)',  border: 'rgba(249,115,22,0.32)',  title: 'Payslip Access',    desc: 'View and download your monthly payslips' },
    { icon: <BarChart3 className="w-4 h-4" style={{ color: '#fdba74' }} />,  bg: 'rgba(251,146,60,0.15)',  border: 'rgba(251,146,60,0.28)',  title: 'Attendance Report', desc: 'Personal attendance summary and analytics' },
    { icon: <UserCircle className="w-4 h-4" style={{ color: '#fed7aa' }} />, bg: 'rgba(253,186,116,0.15)', border: 'rgba(253,186,116,0.28)', title: 'My Profile',        desc: 'Update personal info and preferences' },
  ];

  const tickers = [
    { label: 'Real-Time Clock In/Out',      color: '#fb923c' },
    { label: 'Selfie Verification',          color: '#fdba74' },
    { label: 'Leave Management',             color: '#fed7aa' },
    { label: 'Timesheet Access',             color: '#fb923c' },
    { label: 'Payslip Downloads',            color: '#fdba74' },
    { label: 'Overtime Tracking',            color: '#fed7aa' },
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .el-root {
          ...
          position: relative; background: #0a0500;
        }
        ...
        .el-bg::after {
          ...
          background: linear-gradient(135deg, rgba(18,8,2,0.95) 0%, rgba(25,10,3,0.91) 50%, rgba(15,6,2,0.95) 100%);
        }
        ...
        .el-orb-1 { width: 600px; height: 600px; top: -200px; left: -150px; background: radial-gradient(circle, #ea580c, transparent); }
        .el-orb-2 { width: 450px; height: 450px; bottom: -150px; right: -100px; background: radial-gradient(circle, #c2410c, transparent); }
        .el-orb-3 { width: 350px; height: 350px; top: 40%; right: 20%; background: radial-gradient(circle, #f97316, transparent); opacity: 0.07; }
        ...
        .el-left {
          ...
          background: linear-gradient(160deg, rgba(249,115,22,0.07) 0%, rgba(255,255,255,0.018) 50%, rgba(234,88,12,0.05) 100%);
        ...
        .el-brand-icon {
          ...
          background: rgba(249,115,22,0.2); border: 1px solid rgba(249,115,22,0.35);
        ...
        .el-headline span {
          background: linear-gradient(90deg, #fb923c, #fdba74, #fcd34d);
        ...
        .el-carousel::before { left: 0;  background: linear-gradient(to right, rgba(18,8,2,0.92), transparent); }
        .el-carousel::after  { right: 0; background: linear-gradient(to left,  rgba(18,8,2,0.92), transparent); }
        ...
        .el-slide:hover { border-color: rgba(249,115,22,0.38); background: rgba(249,115,22,0.06); }
        ...
        .el-ticker::before { left: 0;  background: linear-gradient(to right, rgba(18,8,2,0.95), transparent); }
        .el-ticker::after  { right: 0; background: linear-gradient(to left,  rgba(18,8,2,0.95), transparent); }
        .el-ticker-track {
          display: flex; gap: 0;
        ...
        .el-note-title { font-size: 12px; font-weight: 600; color: #fdba74; margin-bottom: 3px; }
        ...
        .el-right {
          ...
          background: linear-gradient(160deg, rgba(120,50,5,0.12) 0%, rgba(180,70,10,0.08) 40%, rgba(100,40,5,0.10) 100%);
          backdrop-filter: blur(12px);
        ...
        .el-icon-wrap {
          ...
          display: flex; align-items: center; justify-content: center;
          margin: 0 auto 14px;
          box-shadow: 0 0 44px rgba(249,115,22,0.2);
        }
        ...
        .el-input:focus {
          background: rgba(249,115,22,0.13); border-color: rgba(249,115,22,0.58);
        ...
        .el-btn {
          ...
          box-shadow: 0 6px 26px rgba(234,88,12,0.35);
        ...
        .el-btn:hover { transform: translateY(-1px); box-shadow: 0 10px 34px rgba(234,88,12,0.52); }
        ...
        .el-admin-box span { color: #fdba74; font-weight: 600; }
        .el-admin-box a { color: #fb923c; font-weight: 600; text-decoration: none; }
        .el-admin-box a:hover { color: #fdba74; text-decoration: underline; }
        ...
        .el-secure {
          ...
          font-size: 11px; color: rgba(253,186,116,0.75); font-weight: 500;
        }
      ...
      <div className="el-root">
        ...
        <div className="el-left">
          <div>
            ...
            <div className="el-stats">
              <div className="el-stat">
                <div className="el-stat-num" style={{ color: '#fb923c' }}>Live</div>
                <div className="el-stat-label">Attendance</div>
              </div>
              <div className="el-stat">
                <div className="el-stat-num" style={{ color: '#fdba74' }}>24/7</div>
                <div className="el-stat-label">Access</div>
              </div>
              <div className="el-stat">
                <div className="el-stat-num" style={{ color: '#fcd34d' }}>L2</div>
            ...
            <div className="el-note">
              <UserCircle className="w-4 h-4" style={{ color: '#fdba74', flexShrink: 0, marginTop: 1 }} />
              <div>
          ...
          <div className="el-footer">
            <CheckCircle2 className="w-3.5 h-3.5" style={{ color: '#fb923c', flexShrink: 0 }} />
        ...
        <div className="el-right">
          ...
          <div className="el-form-header">
            <div className="el-icon-wrap">
              <UserCircle className="w-7 h-7" style={{ color: '#fb923c' }} />
            </div>
          ...
          <div className="el-secure">
            <CheckCircle2 className="w-3 h-3" style={{ color: '#fb923c' }} />
